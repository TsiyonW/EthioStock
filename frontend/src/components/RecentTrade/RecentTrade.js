...
<br/><br/>
                    ...
                    <div className="recenttrade-indicators">
                        ...
                        <p><span className="sell-indicator">Sell</span><span className="sell-figure">52.56</span></p><br/>
                        <p><span className="buy-indicator">Buy</span><span className="buy-figure">52.56</span></p>
                    </div>
                    <br/>
                    <div>
                        <ul>
                            <li className="left-head">View</li>
                            <li className="right-head">Change: -0.24</li>
                        </ul>
                    </div>
